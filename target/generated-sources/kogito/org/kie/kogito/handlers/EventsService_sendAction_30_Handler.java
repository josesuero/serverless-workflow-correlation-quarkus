...
public class EventsService_sendAction_30_Handler implements org.kie.kogito.internal.process.runtime.KogitoWorkItemHandler {

    org.kie.kogito.examples.EventsService service;

    public EventsService_sendAction_30_Handler() {
        this(new org.kie.kogito.examples.EventsService());
    }

    @javax.inject.Inject()
    public EventsService_sendAction_30_Handler(org.kie.kogito.examples.EventsService service) {
    ...
    public void executeWorkItem(org.kie.kogito.internal.process.runtime.KogitoWorkItem workItem, org.kie.kogito.internal.process.runtime.KogitoWorkItemManager workItemManager) {
        service.sendAction((com.fasterxml.jackson.databind.JsonNode) workItem.getParameter("actionName"), org.jbpm.util.ContextFactory.fromItem(workItem));
    ...
    public String getName() {
        return "org.kie.kogito.examples.EventsService_sendAction_30_Handler";
    }
}
