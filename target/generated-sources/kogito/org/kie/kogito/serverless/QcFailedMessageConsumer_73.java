...
public class QcFailedMessageConsumer_73 extends QuarkusMessageConsumer<JsonNodeModel, com.fasterxml.jackson.databind.JsonNode> {
    ...
    void init() {
        init(process, "handling_unit_canceled_event", com.fasterxml.jackson.databind.JsonNode.class, eventReceiver, correlation);
    }
