...
public class QcFailedMessageConsumer_2 extends QuarkusMessageConsumer<JsonNodeModel, com.fasterxml.jackson.databind.JsonNode> {
    ...
    void init() {
        init(process, "new_exception_event_type", com.fasterxml.jackson.databind.JsonNode.class, eventReceiver, correlation);
    }
